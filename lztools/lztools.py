...
from lztools import zlick, constants
...
@main.group(context_settings=CONTEXT_SETTINGS, cls=zlick.CommandMatchingGroup)
def files():
    pass
...
@main.group(cls=zlick.CommandMatchingGroup, context_settings=CONTEXT_SETTINGS)
def docker():
